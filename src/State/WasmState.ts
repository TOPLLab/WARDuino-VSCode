...
import { WOODState, FRAME_FUNC_TYPE } from '../Model/RuntimeState/WOODState';
import { WOODDumpResponse } from '../Model/RuntimeState/WOODDumpResponse';
import { Frame } from '../Model/RuntimeState/Frame';
import { InterruptEvent } from '../Model/RuntimeState/InterruptEvent';
import { StackValue } from '../Model/RuntimeState/StackValue';
...
export class WasmState {
    ...
    static deserialize(serializedState: string, sourceMap: SourceMap): WasmState {
        const ws = WOODState.deserialize(serializedState);
